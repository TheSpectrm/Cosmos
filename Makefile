...
build:
	...
	$(CXX) -shared -LCosmos/Lib bin/Cosmos/int/Core/Application.obj bin/Cosmos/int/Core/Logger.obj bin/Cosmos/int/Core/Window.obj bin/Cosmos/int/cspch.gch -lglfw3 -lopengl32 -lgdi32 -o bin/Cosmos/Cosmos.dll
